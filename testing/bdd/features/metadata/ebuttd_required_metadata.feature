Feature: Converted EBUTTD file contains required metadata elements
  ...
  Scenario: It parses some XML
    ...
    Examples:
      ...
      | complete_document.xml | conformsToStandard | http://www.w3.org/ns/ttml/profile/imsc1/text |
      | complete_document.xml | conformsToStandard | urn:ebu:tt:distribution:2018-04              |
