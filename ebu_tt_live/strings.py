...
ERR_DOCUMENT_SEQUENCE_NO_REF_CLOCK = gettext('Sequence has no reference clock')
ERR_DOCUMENT_SEQUENCE_NO_DOCSET = gettext('Sequence has no document set')
ERR_DOCUMENT_NO_TT_CONTENT = gettext('Document object has no TTML content binding')
