...
Scenario: Multiple active regions that overlap the application shall exit with an error.
    ...
    Examples:
    | r1_origin   | r1_extent  | r2_origin | r2_extent | r3_origin | r3_extent | p1_begin     | p1_end       | p2_begin     | p2_end       |
    | 14.375% 50% | 71.25% 45% | 30% 65%   | 50% 30%   | 33% 61%   | 22% 34%   | 12:24:25.860 | 12:26:25.860 | 12:25:25.860 | 12:30:25.860 |
