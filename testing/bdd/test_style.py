...
@when(**legacy_name(name='it has a cell resolution of <cell_resolution>'))
...
@when(**legacy_name(name='it contains style S1 with <style_attribute> value <S1_value>'))
