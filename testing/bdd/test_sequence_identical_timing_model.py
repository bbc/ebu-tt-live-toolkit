...
@when(**legacy_name(name='it has dropMode <drop_mode1>'))
def when_drop_mode1(drop_mode1, template_dict):
    template_dict['drop_mode'] = drop_mode1


@when(**legacy_name(name='it has markerMode <marker_mode1>'))
