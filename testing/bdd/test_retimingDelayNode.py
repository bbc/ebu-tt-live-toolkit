...
@then(**legacy_name(name='the retiming delay node with <produced_sequence> will reject it'))
...
@then(**legacy_name(name='the delay node outputs the document at <delayed_avail_time>'))
...
@then(**legacy_name(name='the updated body computed begin time is <updated_body_begin>'))
...
@then(**legacy_name(name='the updated body computed end time is <updated_body_end>'))
...
@then(**legacy_name(name='the updated div computed begin time is <updated_div_begin>'))
...
@then(**legacy_name(name='the updated div computed end time is <updated_div_end>'))
...
@then(**legacy_name(name='the updated p computed begin time is <updated_p_begin>'))
...
@then(**legacy_name(name='the updated p computed end time is <updated_p_end>'))
...
@then(**legacy_name(name='the updated span computed begin time is <updated_span_begin>'))
...
@then(**legacy_name(name='the updated span computed end time is <updated_span_end>'))
...
@then(**legacy_name(name='the updated span2 computed begin time is <updated_span2_begin>'))
...
@then(**legacy_name(name='the updated span2 computed end time is <updated_span2_end>'))
...
@then(**legacy_name(name='the updated body specified begin time is <updated_body_begin>'))
...
@then(**legacy_name(name='the updated body specified end time is <updated_body_end>'))
...
@then(**legacy_name(name='the updated div specified begin time is <updated_div_begin>'))
...
@then(**legacy_name(name='the updated div specified end time is <updated_div_end>'))
...
@then(**legacy_name(name='the updated p specified begin time is <updated_p_begin>'))
...
@then(**legacy_name(name='the updated p specified end time is <updated_p_end>'))
...
@then(**legacy_name(name='the updated span specified begin time is <updated_span_begin>'))
...
@then(**legacy_name(name='the updated span specified end time is <updated_span_end>'))
...
@then(**legacy_name(name='the updated span2 specified begin time is <updated_span2_begin>'))
...
@then(**legacy_name(name='the updated span2 specified end time is <updated_span2_end>'))
...
@then(**legacy_name(name='the updated document has sequence id <sequence_id_2>'))
def then_updated_seq_id(test_context, sequence_id_2):
    assert test_context['doc'].sequence_identifier == sequence_id_2


@then(**legacy_name(name='the updated document has authoring delay <authoring_delay>'))
