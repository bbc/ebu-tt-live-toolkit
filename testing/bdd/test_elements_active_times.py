...
@then(**legacy_name(name='body active begin time is <body_active_begin>'))
...
@then(**legacy_name(name='body active end time is <body_active_end>'))
...
@then(**legacy_name(name='div active begin time is <div_active_begin>'))
...
@then(**legacy_name(name='div active end time is <div_active_end>'))
...
@then(**legacy_name(name='p active begin time is <p_active_begin>'))
...
@then(**legacy_name(name='p active end time is <p_active_end>'))
...
@then(**legacy_name(name='span1 active begin time is <span1_active_begin>'))
...
@then(**legacy_name(name='span1 active end time is <span1_active_end>'))
...
@then(**legacy_name(name='span2 active begin time is <span2_active_begin>'))
...
@then(**legacy_name(name='span2 active end time is <span2_active_end>'))
