...
ERR_EBUTTD_OVERLAPPING_ACTIVE_AREAS = gettext("The TT-D spec forbids overlapping active areas")
ERR_EBUTTD_REGION_EXTENDING_OUTSIDE_DOCUMENT = gettext("The TT-D spec forbids region extending outside document")
...
ERR_REGION_ORIGIN_TYPE = gettext('EBUTTD origin in region must be in percentages')
ERR_REGION_EXTENT_TYPE = gettext('EBUTTD extent in region must be in percentages')
