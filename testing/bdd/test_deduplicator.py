...
@then(**legacy_name(name='the output document has <style_out_num> styles'))
...
@then(**legacy_name(name='the first output document has <style_out_num_1> styles'))
...
@then(**legacy_name(name='the second output document has <style_out_num_2> styles'))
...
@then(**legacy_name(name='it has <region_out_num> regions'))
...
@then(**legacy_name(name='the first output document has <region_out_num_1> regions'))
...
@then(**legacy_name(name='the second output document has <region_out_num_2> regions'))
